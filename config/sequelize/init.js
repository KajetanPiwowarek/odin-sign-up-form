...
module.exports = () => {
  ...
  Desk.hasMany(Booking, {as: 'Bookings', foreignKey: {name: 'idDesk', allowNull: false}, constraints: true, onDelete: 'CASCADE'});
  Booking.belongsTo(Desk, {as: 'Desk', foreignKey: {name: 'idDesk', allowNull: false}});
    ...
    .then(Bookings => {
      if( !Bookings || Bookings.length == 0 ){
        return Booking.bulkCreate([
          {idUser: allUsers[0].idUser, idDesk: allDesks[0].idDesk, BookingDate: '2023-11-28', BookingTime: '12:00'},
        ]);
      }else {
        return Desks;
      }
